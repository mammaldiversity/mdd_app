...
void main() {
  group('SynonymName logic tests', () {
    ...
    test('getAuthorityCitation ignores authorityParentheses', () {
      ...
      expect(SynonymName(data: dataWithParentheses).getAuthorityCitation(),
          'Jones, 1999');
      ...
      expect(SynonymName(data: dataWithoutParentheses).getAuthorityCitation(),
          'Jones, 1999');
    });
    ...
    test('getAuthoritySeparator handles colon-separated statuses', () {
      ...
      expect(
          SynonymName(data: dataWithColon)
      ...
      expect(
          SynonymName(data: dataWithColonMultiple)
              .shouldSeparateSynonymAuthorityWithColon(),
          true);
      ...
      expect(
          SynonymName(data: dataWithoutColon)
              .shouldSeparateSynonymAuthorityWithColon(),
          false);
    ...
    test('createStructuredTypeLocality constructs correctly', () {
      ...
      final localityString =
          SynonymName(data: dataLocality).createStructuredTypeLocality();
