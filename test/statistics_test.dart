...
void main() {
  group('StatisticsService Data Cleaning', () {
    test(
      'cleanBiogeographicRealmData handles "?" suffix and aggregates correctly',
      () {
        final rawData = [
    ...
    test(
      'cleanIucnStatusData removes text in parentheses and aggregates correctly',
      () {
        final rawData = [
