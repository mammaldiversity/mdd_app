...
class OrderBarChart extends StatefulWidget {
  const OrderBarChart({super.key, required this.stats});

  final MddStatistics stats;

  @override
  State<OrderBarChart> createState() => _OrderBarChartState();
}

class _OrderBarChartState extends State<OrderBarChart> {
  int _topN = 15;
        ...
        Expanded(
          child: LayoutBuilder(
            builder: (context, constraints) {
              final requiredWidth = data.length * (22.0 + 10.0) + 50.0;
