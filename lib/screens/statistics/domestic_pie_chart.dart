...
class _DomesticPieChartState extends State<DomesticPieChart> {
          ...
          Column(
            ...
            children: data.map((e) {
              ...
              return Padding(
                ...
                child: Indicator(
                  color: isDomestic ? Colors.amber : Colors.green.shade700,
                  text: isDomestic ? 'Domestic' : 'Wild',
                  isSquare: true,
                ),
              );
            }).toList(),
  ...
  List<PieChartSectionData> showingSections(List<StatDomesticSpeciesResult> data) {
