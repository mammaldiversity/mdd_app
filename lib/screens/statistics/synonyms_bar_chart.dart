...
class SynonymsBarChart extends StatefulWidget {
  const SynonymsBarChart({super.key, required this.stats});

  final MddStatistics stats;

  @override
  State<SynonymsBarChart> createState() => _SynonymsBarChartState();
}

class _SynonymsBarChartState extends State<SynonymsBarChart> {
  int _topN = 15;
