...
const naturalEarthAsset = 'assets/maps/ne_110m_admin_0_countries.geojson';
...
Future<Map<String, dynamic>> loadNaturalEarthGeoJson() async {
  final source = await rootBundle.loadString(naturalEarthAsset);
  return Map<String, dynamic>.from(jsonDecode(source) as Map);
}

Future<List<NaturalEarthPolygon>> loadNaturalEarthPolygons() async {
  final collection = await loadNaturalEarthGeoJson();
