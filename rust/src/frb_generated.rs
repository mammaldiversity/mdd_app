...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1830609923;
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::writer::DatabaseWriter::new(
                        api_json_data,
                        api_output_dir,
                        api_output_filename,
                        api_to_csv,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::writer::DatabaseWriter::write(&api_that))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__parser__mdd_helper_parse_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::parser::MddHelper::parse(api_bytes))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok =
                        Ok::<_, ()>(crate::api::parser::MddHelper::parse_mdd_zip(api_zip_path))?;
                    std::result::Result::Ok(output_ok)
                })())
            }
        },
...
fn wire__crate__api__parser__mil_helper_extract_mil_version_impl(
    port_: flutter_rust_bridge::for_generated::MessagePort,
    ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,
    rust_vec_len_: i32,
    data_len_: i32,
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "mil_helper_extract_mil_version",
            port: Some(port_),
            mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal,
        },
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(
                        crate::api::parser::MilHelper::extract_mil_version(&api_path),
                    )?;
                    std::result::Result::Ok(output_ok)
                })())
            }
...
fn wire__crate__api__parser__mil_helper_parse_mil_data_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            move |context| {
                transform_result_sse::<_, ()>((move || {
                    let output_ok = Ok::<_, ()>(crate::api::parser::MilHelper::parse_mil_data(
                        api_tar_path,
                        api_db_path,
                    ))?;
                    std::result::Result::Ok(output_ok)
...
impl SseDecode for crate::api::parser::MddHelper {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
...
impl SseDecode for crate::api::parser::MilHelper {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_decode(deserializer: &mut flutter_rust_bridge::for_generated::SseDeserializer) -> Self {
        let mut var_milVersion = <String>::sse_decode(deserializer);
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        1 => wire__crate__api__writer__database_writer_new_impl(port, ptr, rust_vec_len, data_len),
        2 => {
        ...
        6 => wire__crate__api__parser__mil_helper_extract_mil_version_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        7 => wire__crate__api__parser__mil_helper_parse_mil_data_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
...
impl flutter_rust_bridge::IntoDart for crate::api::writer::DatabaseWriter {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            ...
            self.output_filename.into_into_dart().into_dart(),
            self.to_csv.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
...
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::parser::MddHelper {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
...
impl flutter_rust_bridge::for_generated::IntoDartExceptPrimitive for crate::api::parser::MddHelper {}
impl flutter_rust_bridge::IntoIntoDart<crate::api::parser::MddHelper>
    for crate::api::parser::MddHelper
{
    fn into_into_dart(self) -> crate::api::parser::MddHelper {
        self
    }
}
// Codec=Dco (DartCObject based), see doc to use other codecs
impl flutter_rust_bridge::IntoDart for crate::api::parser::MilHelper {
    fn into_dart(self) -> flutter_rust_bridge::for_generated::DartAbi {
        [
            self.mil_version.into_into_dart().into_dart(),
            self.mil_data.into_into_dart().into_dart(),
        ]
        .into_dart()
    }
}
...
impl SseEncode for crate::api::writer::DatabaseWriter {
    ...
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
        ...
        <String>::sse_encode(self.output_filename, serializer);
        <bool>::sse_encode(self.to_csv, serializer);
    }
}
...
impl SseEncode for crate::api::parser::MddHelper {
    // Codec=Sse (Serialization based), see doc to use other codecs
    fn sse_encode(self, serializer: &mut flutter_rust_bridge::for_generated::SseSerializer) {
